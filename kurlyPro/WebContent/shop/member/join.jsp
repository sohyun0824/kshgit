		...
		<div id="main">
			<div id="content">
				...
				<div class="page_aticle">
					<!-- <script src="../data/skin/designgj/godo.password_strength.js" type="text/javascript"></script> -->
					<!-- <script src="../../common_js/join_v1.js?ver=1.16.9"></script> -->
					<div class="type_form member_join ">
																																				<!-- 서브밋하기전 유효성검사O -->
						<form id="form" name="frmMember" method="post" action="../member/join.do" novalidate="novalidate">
							...
							<table class="tbl_comm">
								<tbody>
									<tr class="fst">
										...
										<td>																			<!-- required : 서브밋되기 전 반드시 채워져있어야하는 입력필드 -->
									...
									<tr>
										<th>
											비밀번호<span class="ico">*<span class="screen_out">필수항목</span></span>
										</th>
										<td>
									...
									<tr class="member_pwd">
										<th>
											비밀번호확인<span class="ico">*<span class="screen_out">필수항목</span></span>
										</th>
										<td>
									...
									<tr>
										<th>
											이름<span class="ico">*<span class="screen_out">필수항목</span></span>
										</th>
										<td>
									...
									<tr>
										<th>
											이메일<span class="ico">*<span class="screen_out">필수항목</span></span>
										</th>
										<td>
									...
									<tr class="field_phone">
										<th>
											휴대폰<span class="ico">*<span class="screen_out">필수항목</span></span>
										</th>
										<td>
											<div class="phone_num">
											...
											<div id="codeNum" class="code_num">
												<input type="text" name="auth_code" id="auth_code" value="" size="4" maxlength="6" pattern="[0-9]*" label="인증번호 확인" disabled="" class="inp_confirm" oninput="if(value.length>4)value=value.slice(0,4);$(this).val($(this).val().replace(/[^0-9]/g,''));">
									...
									<tr>
										<th>
											주소<span class="ico">*<span class="screen_out">필수항목</span></span>
										</th>
										<td class="field_address">
											...
											<a href="#none" id="addressSearch" class="search" onclick="popup('../proc/popup_address.jsp',530,500)"> 
									...
									<tr class="select_sex">
										...
										<td>
											<label class=""> 
												<input type="radio" name="sex" value="m"> <span class="ico"></span>남자
											</label> 
											<label class=""> 
												<input type="radio" name="sex" value="w"> <span class="ico"></span>여자
											</label> 
											<label class="checked"> 
												<input type="radio" name="sex" value="n" checked="checked"> <span class="ico"></span>선택안함
											</label>
										</td>
									</tr>
										...
										<td>
											<div class="group_radio">
												<span class="radio_wrapper"> 
													<label> 
														<input type="radio" name="recommend_id" id="recommendId" label="추천인아이디"> <span class="ico"></span>추천인 아이디
													</label>
												</span> 
												<span class="radio_wrapper"> 
													<label> 
														<input type="radio" name="event_name" id="eventName" label="참여이벤트명"> <span class="ico"></span>참여 이벤트명
													</label>
												</span>
											</div>
											<div class="input_wrapper">
												...
												<p class="txt_guide">
													...
													가입 이후, 수정이 불가합니다. <br> 대소문자 및 띄어쓰기에 유의해주세요.
												</p>
											</div>
										</td>
									</tr>
									<tr class="reg_agree">
										<th>
											이용약관동의 <span class="ico">*<span class="screen_out">필수항목</span></span>
										</th>
										<td>
											...
											<div class="check_view">
												<label class="check_agree label_block"> 
													<input type="checkbox" value="" name="agree" required="" label="이용약관"> <span class="ico"></span>이용약관 동의 
															...
															<div class="box_view">
																<div class="txt_view">
																	...
																	*PC통신, 스마트폰 앱, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한
																	...
																	④ "컬리"가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 몰의
																	초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게
																	약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우
																	"컬리"는 개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.<br>
																	⑤ "컬리"가 약관을 개정할 경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고
																	그 이전에 이미 체결된 계약에 대해서는 개정 전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을
																	체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제4항에 의한 개정약관의 공지기간 내에
																	"컬리"에 송신하여 "컬리"의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.<br>
														...
														<div class="box_type">
															...
															<div class="box_view">
																<div class="txt_view">
																	...
																	정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 취급위탁의 경우 등 관련 법령에 달리
																	정함이 있는 경우에는 그에 따릅니다.<br> <br>
														...
														<div class="box_type">
															...
															<div class="box_view">
																<div class="txt_view">
																	...
																	의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호,
																	기타 연락처), 정보의 수집목적 및 이용목적, 제3자에 대한 정보제공 관련사항(제공받은자,
																	제공목적 및 제공할 정보의 내용) 등 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」
																	제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할
																	수 있습니다.<br> ⑥ 이용자는 언제든지 "컬리"가 가지고 있는 자신의 개인정보에 대해
																	열람 및 오류정정을 요구할 수 있으며 "컬리"는 이에 대해 지체 없이 필요한 조치를 취할 의무를
																	집니다. 이용자가 오류의 정정을 요구한 경우에는 "컬리"는 그 오류를 정정할 때까지 당해
																	개인정보를 이용하지 않습니다.<br> ⑦ "컬리"는 개인정보 보호를 위하여 이용자의
																	개인정보를 취급하는 자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한 이용자의
																	개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조 등으로 인한 이용자의 손해에 대하여
																	모든 책임을 집니다.<br> ⑧ "컬리" 또는 그로부터 개인정보를 제공받은 제3자는
																	개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해 개인정보를 지체 없이 파기합니다.<br>
																	⑨ "컬리"는 개인정보의 수집/이용/제공에 관한 동의란을 미리 선택한 것으로 설정해두지 않습니다.
														...
														<div class="box_type">
															...
															<div class="box_view">
																<div class="txt_view">
																	...
																	지적재산권에 대한 침해<br> 6. "컬리" 기타 제3자의 명예를 손상시키거나 업무를
																	방해하는 행위<br> 7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에
																	반하는 정보를 몰에 공개 또는 게시하는 행위<br> <br>

																	<!--23조-->
																	제23조(저작권의 귀속 및 이용제한)<br> ① "컬리"가 작성한 저작물에 대한 저작권
																	기타 지적재산권은 "컬리"에 귀속합니다.<br> ② 이용자는 "컬리"를 이용함으로써 얻은
																	정보 중 "컬리"에게 지적재산권이 귀속된 정보를 "컬리"의 사전 승낙 없이 복제, 송신, 출판,
																	배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.<br>
																	③ "컬리"는 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우 당해 이용자에게 통보하여야
																	합니다.<br> <br>
																	...
																	<!--부칙-->
																	* 부칙<br> 1. 이 약관은 2020년 03월 11일부터 시행됩니다.<br>
											...
											<div class="check_view">
												<label class="check_agree label_block"> 
													<input type="checkbox" id="private1" name="private1" value="" required="" label="개인정보처리방침"> 
													<span class="ico"></span>개인정보처리방침 동의 <span class="sub">(필수)</span>
												</label> 
															...
															<table cellpadding="0" cellspacing="0" width="100%">
																...
																<tbody>
																	<tr>
																		...
																		<td rowspan="4">회원 탈퇴 즉시 파기 <br><br>부정이용 방지를 위하여 30일 동안 보관 (아이디, 휴대폰 번호) 후 파기</td>
																	</tr>
																	<tr>
																		<td>거점 기반 서비스 제공</td>
																	</tr>
					...
					<!-- password 관련 스크립트 -->
					<!-- <script src="../data/skin/designgj/js/pw_validate.js?ver=1.16.9"></script> -->
					
					<!-- 주소 검색 관련 스크립트 -->
					<!-- <script src="../data/skin/designgj/js/delivery_address.js?ver=1.16.9"></script> -->
					...
					<script type="text/javascript">
						$(document).ready(function() {
							...
							// 사용자 아이디와 추천인 아이디 중복 안되도록 처리
							var recommId = $('[name=recommid]');
							var mId = $('[name=m_id]');
							// blur() : focusin 에서 focusout으로 변경될때의 이벤트
							$(recommId, mId).blur(function() {
									if ($.trim(mId.val()) !== '' && $.trim(recommId.val()) !== '' && recommId.val() === mId.val() ) {
										recommId.val('');		// 추천인 아이디에 본인 아이디를 입력한 경우 추천인 아이디의  value를 빈칸으로 만듦
							...
							$('.check_view .btn_link').on('click', function(e) {
									...
									var layer1 = $(this).is('.btn_agreement');		// 약관1 내용보기 버튼이라면..
									var layer2 = $(this).is('.btn_essential');		// 약관2 내용보기 버튼이라면..
									var layer3 = $(this).is('.btn_choice');			// 약관3 내용보기 버튼이라면..
									var bgDimd = $('.bg_dim');							// 아무것도 없는 div..
									var target = $(this).parents('.reg_agree').find('.layer');		// 모든 약관 공통클래스 layer

									var agreement = $(this).parents('.reg_agree').find('.layer_agreement');	// 약관1의 내용
									var essential = $(this).parents('.reg_agree').find('.layer_essential');		// 약관2의 내용
									var choice = $(this).parents('.reg_agree').find('.layer_choice');				// 약관3의 내용
									var topResult = null;
									...
									topResult.css({'margin-top' : -topResult.height() / 2});
							});
							...
							$('.check_agree input[name = agree_allcheck]').change(function() {
									if ($(this).is(':checked') === true) {
										...
										agree.find('input[type=checkbox]').prop('checked', 'checked');		// 자바스크립트로서의 checked 속성값 설정
							...
							$('.reg_agree').find('input[type=checkbox]').change(function() {
									...
									if ($(this).attr('name') === 'mailling' || $(this).attr('name') === 'sms') {
										...
										// mailing과 sms 둘다 체크시 marketing 체크 설정
										if (emailSmsCount === 2) {
							...
							// 글자 갯수확인 + 문장조합확인
							var checkType1 = false;	// 갯수 확인
							var checkType2 = false;	// 숫자, 문자, 특수문자 중 2가지가 섞인 조합일 때 true
							var checkType3 = false;	// 문자만 있을 때 true
							...
							$('[name=m_id]').on('keyup',function() {
								...
								if (saveId !== chkVal) {
									$("[name=chk_id]").val('1');
									class_change(target.find('.txt_case2'),'bad');// 중복확인후 수정될때
								}
							...
							// 비밀번호검증
							$('[name=password], [name=password2]').on('focus',function() {
								$(this).parent().find('.txt_guide').show();
							});
							$('[name=password], [name=password2]').on('blur',function() {
							...
							$('input[name=password2]').on('keyup',function() {
								...
								if (($("[name=password]").val() === $('[name=password2]').val() && $.trim($("[name=password]").val()) != "")) {
									class_change(target.find('.txt_case1'),'good');
								} else {
									class_change(target.find('.txt_case1'),'bad');
								}
							...
							$('input[name=password]').on('keyup',function(e) {
								...
								if (hasThreeOrMoreConsecutiveNumbers(chkVal)) {
							...
							$('[name=email]').on('keyup',function() {
								var chkVal = $(this).val();
								if (saveId !== chkVal) $("[name=chk_email]").val('1');
							});
